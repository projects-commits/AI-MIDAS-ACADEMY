...
import frameworkStep4 from "../../../../imagens_framework/PASSO_4_FRAMEWORK.png";

<BlackboardPanel title={"Mapa operacional: Passo 4: Crença, filosofia e princípios de jogo"} label="Quadro">
  <img class="framework-visual__image" src={frameworkStep4.src} alt="Mapa visual do Passo 4 do framework: crença, filosofia e princípios de jogo." loading="eager" />
  <p class="framework-visual__caption">Mapa visual do passo 4 para fixar a estrutura da aula antes da leitura operacional.</p>
