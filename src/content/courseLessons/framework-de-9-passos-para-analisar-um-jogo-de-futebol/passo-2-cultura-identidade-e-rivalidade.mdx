...
import frameworkStep2 from "../../../../imagens_framework/PASSO_2_FRAMEWORK.png";

<BlackboardPanel title={"Mapa operacional: Passo 2: Cultura, identidade e rivalidade"} label="Quadro">
  <img class="framework-visual__image" src={frameworkStep2.src} alt="Mapa visual do Passo 2 do framework: cultura, identidade e rivalidade." loading="eager" />
  <p class="framework-visual__caption">Mapa visual do passo 2 para fixar a estrutura da aula antes da leitura operacional.</p>
